...
class GoogleVision {
  ...
  static const MethodChannel channel =
      MethodChannel('plugins.flutter.brianmtully.com/run_access_facial');
...
class GoogleVisionImageMetadata {
  ...
  /// See https://developer.apple.com/documentation/corevideo/1563591-pixel_format_identifierslanguage=objc
  ///
  /// Not used on Android.
